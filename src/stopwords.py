STOPWORDS = ['granpy', 'ou', 'se', 'trouve', 'la', 'au','aux', 'avec',
'ce', 'ces', 'dans', 'de', 'des', 'du', 'elle', 'en', 'et', 'eux', 'il',
'ils', 'je', 'la', 'le', 'les', 'leur', 'lui', 'ma', 'mais', 'me', 'même',
...
'fussiez', 'fussent', 'ayant', 'ayante', 'ayantes', 'aies', 'ait', 'ayons',
...
'eûmes', 'eûtes', 'eurent', 'aie','ayez', 'aient', 'eusse', 'eusses',
'eût', 'eussions', 'eussiez', 'eussent', '.', ',' , '!', '?', ':', ';',
'situe', 'situer', 'localiser', 'trouver', 'avoir', 'localise', 'borner',
'cerner', 'délimiter', 'fixer', 'positionner', 'position', 'détecter',
'repérer', 'entourer', 'adresse', "l'", 'quelle', 'quel', 'qui', 'quoi',
'pourquoi',
]
